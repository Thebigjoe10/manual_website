 ...
 * Footer Component
 *
 * This component serves as the footer section for the TRADELYNK website.
    ...
    <footer className="bg-[#1c1c1c] text-white py-12 px-4 md:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
        ...
        <div className="space-y-4">
          <h2 className="text-2xl font-bold">TRADELYNK</h2>
          <p className="text-sm">
            8569 Bond Rd, Elk Grove, California, 95624, United States.
          </p>
          <p className="text-sm ">contact@tradelynk.com</p>
