...
import { GiPerfumeBottle, GiClothesline } from "react-icons/gi";
import { FaBath } from "react-icons/fa";
import { PiHighlighterCircleBold } from "react-icons/pi";
import { MdFace4, MdOutlineLiving, MdOutlineToys, MdSmartphone, MdFitnessCenter } from "react-icons/md";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-15">
          ...
          <div className="flex-1 flex items-center justify-center lg:w-1/3">
            <Link href={"/"}>
              <h1 className="text-2xl font-bold">TRADELYNK</h1>
            </Link>
          </div>
